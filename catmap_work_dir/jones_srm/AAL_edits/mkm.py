...
#SBATCH -p normal
#SBATCH --job-name=m1_simsteps_jones.py
...
vm.max = 1 #maximum rate to plot (for consistency with production rates)
...
vm.log_scale = False #coverage should not be on a log scale
...
vm.subplots_adjust_kwargs = adjust_kwargs
fig = vm.plot(save='CO_tof.pdf') #consistent naming
